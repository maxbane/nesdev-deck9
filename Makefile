...
#
OBJECTS = locals.o main.o ppu.o joy.o coroutine.o effects.o console.o ascii.o

#
# Object file dependencies, other than the implicit %.s
#
main.o: 			locals.inc ines.inc ppu.inc joy.inc constants.inc \
					math_macros.inc chr/pc-bios.chr \
					coroutine.inc effects.inc console.inc ascii.inc
joy.o: 				locals.inc
...
console.o:			console.inc math_macros.inc locals.inc ppu.inc ascii.inc
ascii.o:			ascii.inc locals.inc math_macros.inc
